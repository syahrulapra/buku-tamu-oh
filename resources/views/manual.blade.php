    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto w-4/12 md:h-screen lg:py-0">
        <div class="w-full bg-white rounded-lg shadow light:border md:mt-0 sm:max-w-md xl:p-0 light:bg-gray-800 light:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="{{ url('manual/aksi') }}" method="post">
                    {{ csrf_field() }}
                    <div class="mt-4">
                    ...
                    <div class="mt-4">
                        <input type="number" name="jumlah" placeholder="Jumlah Orang (Lewati jika hanya 1)" class="text-lg bg-gray-50 border border-gray-300 text-gray-900 p-2">
                    </div>
                    <div class="mt-4">
                        <label for="hari" class="block mb-2 text-sm font-medium text-blue-500 light:text-white">Hari</label>
